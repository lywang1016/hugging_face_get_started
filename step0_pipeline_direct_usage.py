...
# Chinese to English
zh_en_model = pipeline("translation", model="Helsinki-NLP/opus-mt-zh-en")

res = zh_en_model("哎呦，你干嘛？", src_lang='zh', tgt_lang='en') 
print(res[0]['translation_text'])

# Test use default model
default_model = pipeline("translation_en_to_fr")
res = default_model("How old are you?") 
print(res[0]['translation_text'])
